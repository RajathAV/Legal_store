...
export function makeAuthRequest(
  ...
  redirectURI?: string, 
  manifestURI?: string, 
  scopes: string[] = <span class="branch-0 cbranch-no" title="branch not covered" >DEFAULT_SCOPE,</span>
  appDomain?: string,
...
&nbsp;
  const getWindowOrigin = <span class="fstat-no" title="function not covered" >(p</span>aramName: string) =&gt; {
    const origin = <span class="cstat-no" title="statement not covered" >typeof window !== 'undefined' &amp;&amp; window.location &amp;&amp; window.location.origin</span>
    if (!origin) {
      const errMsg = <span class="cstat-no" title="statement not covered" >`\`makeAuthRequest\` called without the \`${paramName}\` param specified but`</span>
