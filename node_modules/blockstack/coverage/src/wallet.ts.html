...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  static </span>fromEncryptedMnemonic(data: string, password: string) {
<span class="cstat-no" title="statement not covered" >    return decryptMnemonic(data, password)</span>
      .then(<span class="fstat-no" title="function not covered" >(m</span>nemonic) =&gt; {
        const seed = <span class="cstat-no" title="statement not covered" >bip39.mnemonicToSeed(mnemonic)</span>
...
&nbsp;
   ...
   */
  getIdentityKeyPair(addressIndex: number, alwaysUncompressed: boolean = <span class="branch-0 cbranch-no" title="branch not covered" >false)</span>: IdentityKeyPair {
