...
<span class="cstat-no" title="statement not covered" >    throw new Error('Failed in parsing legacy challenge text from the gaia hub.')</span>
  ...
  if (parsedChallenge[0] === 'gaiahub'
    ...
    const digest = <span class="cstat-no" title="statement not covered" >bitcoin.crypto.sha256(Buffer.from(challengeText))</span>
&nbsp;
    const signatureBuffer = <span class="cstat-no" title="statement not covered" >signer.sign(digest)</span>
    const signatureWithHash = <span class="cstat-no" title="statement not covered" >bitcoin.script.signature.encode(</span>
