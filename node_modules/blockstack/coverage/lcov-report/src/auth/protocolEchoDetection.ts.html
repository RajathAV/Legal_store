...
export function protocolEchoReplyDetection(): boolean {
  ...
  if (typeof window !== 'object' || <span class="branch-1 cbranch-no" title="branch not covered" >!window.location </span>|| <span class="branch-2 cbranch-no" title="branch not covered" >!window.localStorage)</span> {
...
&nbsp;
  ...
  const existingDetection = (<span class="cstat-no" title="statement not covered" >window as any)[GLOBAL_DETECTION_CACHE_KEY]</span>
  if (typeof existingDetection === 'boolean') {
<span class="cstat-no" title="statement not covered" >    return existingDetection</span>
  }
&nbsp;
  const searchParams = <span class="cstat-no" title="statement not covered" >new window.URLSearchParams(window.location.search)</span>
  const echoReplyParam = <span class="cstat-no" title="statement not covered" >searchParams.get(ECHO_REPLY_PARAM)</span>
  if (echoReplyParam) {
    (<span class="cstat-no" title="statement not covered" >window as any)[GLOBAL_DETECTION_CACHE_KEY] = true</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    window.localStorage.setItem(echoReplyKey, 'success')</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      window.location.href = authContinuationParam</span>
    }, 10)
&nbsp;
